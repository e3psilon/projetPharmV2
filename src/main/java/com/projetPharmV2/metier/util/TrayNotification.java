...
public class TrayNotification {
	...
	public void setNotificationType(NotificationType nType) {
		...
		case INFORMATION:
			imageLocation = getClass().getResource("/icon/info.png");
			paintHex = "#2C54AB";
			break;

		case NOTICE:
			imageLocation = getClass().getResource("/icon/notice.png");
			paintHex = "#8D9695";
			break;

		case SUCCESS:
			imageLocation = getClass().getResource("/icon/success.png");
			paintHex = "#009961";
			break;

		case WARNING:
			imageLocation = getClass().getResource("/icon/warning.png");
			paintHex = "#E23E0A";
			break;

		case ERROR:
			imageLocation = getClass().getResource("/icon/error.png");
			paintHex = "#CC0033";
			break;
